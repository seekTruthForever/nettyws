...
public class MessageFrameHandler  extends SimpleChannelInboundHandler<WebSocketFrame> {
	private static final Logger logger = LoggerFactory.getLogger(MessageFrameHandler.class);
